...
from easy_grammar import Grammar, Rule, Expression, Alternative, Ebnf, Nonterminal, Terminal, Directive
...
if __name__ == "__main__" :
    ...
    initSymbols (grammar)
    for rule in grammar.rules :
       print (rule.name, "starts with")
       sym_set = rule.first
       for inx in range (grammar.symbol_cnt) :
          if sym_set [inx] :
             sym = grammar.symbols [inx]
             print ("   ", sym.alias)
       print ()
