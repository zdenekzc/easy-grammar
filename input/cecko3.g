...
variable_expr <CmmVarExpr:CmmExpr> :
  name:identifier
  <execute on_variable_expr> ;

int_value_expr <CmmIntValue:CmmExpr> :
  value:number;

real_value_expr <CmmRealValue:CmmExpr> :
  value:real_number;

char_value_expr <CmmCharValue:CmmExpr> :
  value:character_literal;

string_value_expr <CmmStringValue:CmmExpr> :
  value:string_literal;

subexpr_expr <CmmSubexprExpr:CmmExpr> :
  '(' inner_expr:expr ')' ;

sequence_expr <CmmSequenceExpr:CmmExpr> :
  '[' param:expr_list ']' ;
...
index_expr <CmmIndexExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  '[' param:expr_list ']' ;

call_expr <CmmCallExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  '(' param_list:expr_list ')' ;

compound_expr <CmmCompoundExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  body:compound_stat ;

field_expr <CmmFieldExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  <no_space> '.' <no_space>
  name:identifier
  <execute on_field_expr> ;

ptr_field_expr <CmmPtrFieldExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  <no_space> "->" <no_space>
  name:identifier ;

post_inc_expr <CmmPostIncExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  "++" ;

post_dec_expr <CmmPostDecExpr:CmmPostfixExpr>:
  <store left:CmmExpr>
  "--" ;
...
inc_expr <CmmUnaryExpr:CmmExpr>:
  "++" param:unary_expr;

dec_expr <CmmUnaryExpr:CmmExpr>:
  "--" param:unary_expr;

deref_expr <CmmUnaryExpr:CmmExpr>:
  '*' param:unary_expr;

addr_expr <CmmUnaryExpr:CmmExpr>:
  '&' param:unary_expr;

plus_expr <CmmUnaryExpr:CmmExpr>:
  '+' param:unary_expr;

minus_expr <CmmUnaryExpr:CmmExpr>:
  '-' param:unary_expr;

bit_not_expr <CmmUnaryExpr:CmmExpr>:
  '~' param:unary_expr;

log_not_expr <CmmUnaryExpr:CmmExpr>:
  '!' param:unary_expr;
